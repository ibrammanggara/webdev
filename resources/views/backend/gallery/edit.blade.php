    ...
    <div class="bg-white rounded-2xl shadow p-6">
        <form action="{{ route('gallery.update', $gallery) }}"
            ...
            <div>
                ...
                <label
                    class="relative flex items-center justify-center w-full h-72 border-2 border-dashed rounded-xl cursor-pointer
                    ...
                    <div id="uploadOverlay"
                        ...
                        <svg class="w-10 h-10" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M12 16.5v-9m0 0L8.25 11.25M12 7.5l3.75 3.75"/>
                        </svg>
                        <p class="text-sm">
