    ...
    @if(session('success') || $errors->any())
        ...
        >
            ...
            <div class="mt-0.5">
                ...
                @else
                    <svg class="w-5 h-5 text-rose-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="bg-orange-100 text-orange-600 p-3 rounded-lg">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M20.25 7.5l-8.25-4.5-8.25 4.5m16.5 0v9.75A2.25 2.25 0 0118.75 19.5H5.25A2.25 2.25 0 013 17.25V7.5m17.25 0L12 12.75 3.75 7.5" />
                    </svg>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('users.store') }}" method="POST"
                    ...
                    <div class="flex-1">
                        ...
                        <input
                            ...
                            class="w-full rounded-lg px-3 py-2 bg-white border border-slate-200
                    ...
                    <button
                        type="submit"
                        class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg transition shadow-sm cursor-pointer"
                    >
                        Tambah User
                    </button>
                </form>
                                ...
                                <td class="p-4">
                                    <form method="POST" action="{{ route('users.destroy', $user) }}">
                                        ...
                                        <button
                                            ...
                                            class="text-rose-500 hover:text-rose-600 text-sm cursor-pointer"
                                        >
                                            Hapus
                                        </button>
                                    </form>
